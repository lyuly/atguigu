...
(()=>{
  ...
  console.log(und)
  console.log(nll)
  // undefined 和 null 都可以作为其他类型的子类型,把undefined和null赋值给其他类型的的变量,如:number类型的变量
  ...
  let arr3:[string,number,boolean] = ['夏天天', 100, true]
  console.log(arr3)
 ...
 /*  enum Gender{
  ...
  // console.log(getObj({name: '李四',age:'20'}))
